 ...
 * Run this script with: node scripts/simple-admin.js <user-uid>
 */
...
if (!uid) {
  console.log('Usage: node scripts/simple-admin.js <user-uid>');
  console.log('');
  console.log('To get a user UID:');
  console.log('1. Go to Firebase Console > Authentication > Users');
  console.log('2. Find the user and copy their UID');
  console.log('3. Run: node scripts/simple-admin.js <uid>');
  console.log('');
